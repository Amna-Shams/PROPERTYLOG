...
let rawUrl = (import.meta as any).env?.VITE_SUPABASE_URL || "https://mmfalbfdtxmugjyqefje.supabase.co";

// Sanitize URL: strip trailing slashes and '/rest/v1' if mistakenly appended
